...
$winscppath = "C:\Program Files\WinSCPAuto\"
Add-Type -Path (Join-Path $winscppath "WinSCPnet.dll")
$localhost = "ftp.accela.com"
$ftpuser = "sanfrancisco"
$ftppwd = "AAutomation92211"
...
$sessionOptions = Set-SFTPSessionOption -HostName $localhost -UserName $ftpuser -Password $ftppwd
### -SshHostKey "ssh-rsa 1024 fd:6b:73:e4:52:b2:56:ac:2a:fb:a8:64:53:ca:59:90"
...
$ReadResults = Read-FromSFTPServer -Session $session -RemotePath ".\Export4PIM\RelatedBuildingPermits.csv" -LocalPath "C:\Users\chingyiuting\Downloads"
