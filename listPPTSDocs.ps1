...
# Document group starts with PLN
...
$prop = $mfVault.PropertyDefOperations.GetPropertyDefIDByAlias("M-Files.Property.DocumentGroup")
...
#        Write-Host $mfVault.GetGUID() " has this object " $mfResult.ObjectGUID " with this file " $file.FileGUID
       ...
       $mFile = New-Object PSObject -Property @{
         ...
         $mFiles += $mFile
         $mFiles | Export-Csv C:\Users\achinn\Downloads\PPTSdocsPLN2.csv -delimiter "|"
